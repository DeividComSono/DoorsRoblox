...
Security
Insights
Utilities/Doors Entity Spawner/Source.lua
@RegularVynixu
RegularVynixu Update Source.lua
Latest commit 4882682 10 days ago
 History
 1 contributor
500 lines (379 sloc)  14.9 KB
...
Creator.runEntity = function(entity)
    ...
    for _, room in next, workspace.ActiveRooms:GetChildren() do
    ...
    local firstRoom = workspace.ActiveRooms:GetChildren()[1]
